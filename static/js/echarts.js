function startClock() {
  var t = null;
  t = setTimeout(updateTime, 1000); //开始运行
...
function echarts31() {
  ...
  echarts_31 = echarts.init(document.getElementById("fb1"));
...
function echarts32() {
  echarts_32 = echarts.init(document.getElementById("fb2"));
